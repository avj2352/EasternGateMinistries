...
function get_artwork($artwork, $numwords = 50){
    $string = '';
    $string .= '<img src="' . base_url('img/gallery/'.$artwork->path). '" width="300px" height="200px" class="thumbnail"/>';
    $string .= '<div class = "thumbnail_title"><p align="center">' . e($artwork->title) . '</p></div>';
...
function google_map(){
    $string = '';
    $string .= '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.154012306373!2d77.54585600000001!3d13.089424!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae228e1c803403%3A0xef0ba1424f8cd4a9!2sSambhram+Institute+of+Technology!5e0!3m2!1sen!2sin!4v1405265654096" width="270" height="350" frameborder="0" style="border:0"></iframe>';
    return $string;
}