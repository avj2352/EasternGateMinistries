...
class User extends Admin_Controller {
	...
	public function login(){
		...
		/*For validation of the Login Screen*/
	...
	/*This method is not required in the production system*/
	public function getHashValue(){
		var_dump($this->user_m->hash('zuko2352'));
		die();
	}/*end of the getHashValue method*/
