...
class Page extends Admin_Controller {
	...
	/*This is being called inside of the page_m ->$rules array*/
	public function _unique_slug($str){
		/*The way we set this is up is similar to is_unique() of CI*/
		/*Except we check for an Exception*/
		/*_unique_slug() - This is only called in the Edit page form*/
		...
		/*We should look for the slug as unique, only except for the current page*/
		...
		return TRUE;
	}/*End of the custom callback: _unique_slug method*/

	/*This is being called inside of the page_m ->$rules array*/
	public function _unique_title($str){
		/*The way we set this is up is similar to is_unique() of CI*/
		/*Except we check for an Exception*/
		/*_unique_title() - This is only called in the Edit page form*/
		/*Do not Validate if the the title already exists*/
		/*UNLESS its the title for the currently updated page*/
		$id = $this->uri->segment(4);
		$page = $this->db->where('title', $this->input->post('title'));
		/*We should look for the title as unique, only except for the current page*/
		/*If we donot have a page ID then ignore this line*/
		!$id || $this->db->where('id !=', $id);
		$page = $this->page_m->get();
		/*If the page is found*/
		...
		return TRUE;
	}/*End of the custom callback: _unique_title method*/
